...
args: [],
source: unescape('login%0A%7C%20dict%20%7C%0Adict%20%3A%3D%20Dictionary%20new.%20%0Adict%20at%3A%20%27_id%27%20put%3A%20%28%27%23loginUsername%27%20asJQuery%20val%29.%0Adict%20at%3A%20%27password%27%20put%3A%20%28%27%23loginPassword%27%20asJQuery%20val%29.%20%0A%0A%20%20jQuery%20%0A%09%09%09ajax%3A%20%27FileServer%3Flogin%3A%27%0A%09%09%09options%3A%20%23%7B%0A%09%09%09%09%27type%27%20-%3E%20%27POST%27.%0A%09%09%09%09%27success%27%20-%3E%20%5B%20%3Amessage%20%7C%20window%20alert%3A%20message.%20self%20username%3A%20%28dict%20at%3A%20%27_id%27%29.%20self%20password%3A%20%28dict%20at%3A%20%27password%27%20%29%20%5D.%0A%09%09%09%09%27error%27%20-%3E%20%5B%20%3Aex%20%7C%20window%20alert%3A%20%28ex%20responseText%29%20%5D.%0A%09%09%09%09%22%27dataType%27%20-%3E%20%27jsonp%27.%22%0A%09%09%09%09%27data%27%20-%3E%20dict%20asJSONString%0A%09%09%09%7D.'),
messageSends: ["new", "at:put:", "val", "asJQuery", "ajax:options:", unescape("-%3E"), "alert:", "username:", "at:", "password:", "responseText", "asJSONString"],
referencedClasses: ["Dictionary"]
}),
smalltalk.UserContainer);
...
fn: function (onSuccessBlock, onErrorBlock) {
    var self = this;
    smalltalk.send(typeof jQuery == "undefined" ? nil : jQuery, "_ajax_options_", [unescape("FileServer%3Fbrowse%3A"), smalltalk.HashedCollection._fromPairs_([smalltalk.send("type", "__minus_gt", ["POST"]), smalltalk.send("success", "__minus_gt", [onSuccessBlock]), smalltalk.send("data", "__minus_gt", ["bla"]), smalltalk.send("error", "__minus_gt", [function (ex) {return smalltalk.send(onErrorBlock, "_value_", [ex]);}])])]);
    return self;
},
args: ["onSuccessBlock", "onErrorBlock"],
source: unescape('browsePublic%3A%20onSuccessBlock%20onError%3A%20onErrorBlock%0A%0AjQuery%20%0A%09%09%09ajax%3A%20%28%27FileServer%3Fbrowse%3A%27%29%0A%09%09%09options%3A%20%23%7B%0A%09%09%09%09%27type%27%20-%3E%20%27POST%27.%0A%09%09%09%09%27success%27%20-%3E%20onSuccessBlock.%0A%09%09%09%09%27data%27%20-%3E%20%27bla%27.%0A%09%09%09%09%27error%27%20-%3E%20%5B%20%3Aex%20%7C%20onErrorBlock%20value%3A%20ex%20%5D%0A%09%09%09%7D.'),
messageSends: ["ajax:options:", unescape("-%3E"), "value:"],
referencedClasses: []
}),
...
fn: function (aPackage, aUser, aPassword) {
    ...
    try {
        ...
        smalltalk.send(dict, "_at_put_", ["packageMeta", smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.Smalltalk || Smalltalk, "_current", []), "_packageAt_", [aPackage]), "_properties", []), "_asJSONString", [])]);
        smalltalk.send(dict, "_at_put_", ["js", smalltalk.send(smalltalk.send(smalltalk.Exporter || Exporter, "_new", []), "_exportPackage_", [aPackage])]);
...
source: unescape('commit%3A%20aPackage%20user%3A%20aUser%20password%3A%20aPassword%0A%7C%20dict%20%7C%0Adict%20%3A%3D%20Dictionary%20new.%0A%0A%28Smalltalk%20current%20packageAt%3A%20aPackage%29%0A%09isNil%20ifTrue%3A%20%5B%20%5Ewindow%20alert%3A%20%27Package%20not%20found%27%20%5D.%0A%0Adict%20at%3A%20%27packageName%27%20put%3A%20aPackage.%0Adict%20at%3A%20%27packageMeta%27%20put%3A%20%28%28Smalltalk%20current%20packageAt%3A%20aPackage%29%20properties%20asJSONString%29.%0Adict%20at%3A%20%27js%27%20put%3A%20%28Exporter%20new%20exportPackage%3A%20aPackage%29.%0Adict%20at%3A%20%27jsdeploy%27%20put%3A%20%28StrippedExporter%20new%20exportPackage%3A%20aPackage%29.%0Adict%20at%3A%20%27st%27%20put%3A%20%28ChunkExporter%20new%20exportPackage%3A%20aPackage%29.%0Adict%20at%3A%20%27user%27%20put%3A%20aUser.%0Adict%20at%3A%20%27password%27%20put%3A%20aPassword.%0A%0AjQuery%20%0A%09%09%09ajax%3A%20%28%27FileServer%3FcommitPackage%3A%27%29%0A%09%09%09options%3A%20%23%7B%0A%09%09%09%09%27type%27%20-%3E%20%27POST%27.%0A%09%09%09%09%27success%27%20-%3E%20%5B%20%3Amessage%20%7C%20window%20alert%3A%20message.%20%5D.%0A%09%09%09%09%27data%27%20-%3E%20%28dict%20asJSONString%29.%0A%09%09%09%09%27error%27%20-%3E%20%5B%20%3Aex%20%7C%20window%20alert%3A%20%28ex%20responseText%29%20%5D%0A%09%09%09%7D.'),
messageSends: ["new", "ifTrue:", "isNil", "packageAt:", "current", "alert:", "at:put:", "asJSONString", "properties", "exportPackage:", "ajax:options:", unescape("-%3E"), "responseText"],
referencedClasses: ["Dictionary", "Smalltalk", "Exporter", "StrippedExporter", "ChunkExporter"]
}),
smalltalk.PackageHandler);
